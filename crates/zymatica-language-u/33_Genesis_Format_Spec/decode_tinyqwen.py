...
BASE_MODEL = os.path.join(os.path.dirname(os.path.abspath(__file__)), "qwen-3.5-0.8b-local")
PKT_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "packet_1paup.bin")
OUTPUT_MODEL = os.path.join(os.path.dirname(os.path.abspath(__file__)), "SubZero2.lora")
SFT_DATA_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "full_sft_dataset.json")
