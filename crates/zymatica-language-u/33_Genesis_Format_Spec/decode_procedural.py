...
SEED_FILE     = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ProceduralSeed.LLM")
OUTPUT_DIR    = os.path.join(os.path.dirname(os.path.abspath(__file__)), "qwen-3.5-0.8b-procedural-reconstruction")
