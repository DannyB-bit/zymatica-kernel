...
CAPSULE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "qwen-3.5-0.8b-microbyte-3.capsule")
MODEL_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "model")
ADAPTER_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "adapter_model.safetensors")
