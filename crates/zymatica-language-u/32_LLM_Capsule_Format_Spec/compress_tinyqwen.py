...
ADAPTER_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "TinyQwen")
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "packets_tinyqwen")
