...
USAGE:
  ...
  python compress_full_model_chirp3.py --base os.path.join(os.path.dirname(os.path.abspath(__file__)), "qwen-3.5-0.8b-local")
  python compress_full_model_chirp3.py --lora os.path.join(os.path.dirname(os.path.abspath(__file__)), "SubZeroLLM-LORA") --level 5
"""
