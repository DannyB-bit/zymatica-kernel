...
_APP_VERSION = _ZYMATICA_VERSION
_BOT_VERSION = _ZYMATICA_VERSION
_YUANBAO_INSTANCE_ID = str(ZYMATICA_INSTANCE_ID)  # single source: yuanbao_proto.ZYMATICA_INSTANCE_ID
