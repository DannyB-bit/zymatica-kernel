...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ZYMATICA_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_zymatica_dir("platforms/whatsapp/session", "whatsapp/session")
