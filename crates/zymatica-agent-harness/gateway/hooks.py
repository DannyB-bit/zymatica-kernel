...
Hooks are discovered from ~/.zymatica/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- Zymatica session id
...
HOOKS_DIR = get_zymatica_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"zymatica_hook_{hook_name}"
