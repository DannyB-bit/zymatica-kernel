# Zymatica Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.zymatica/plugins/zymatica-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.zymatica/plugins/zymatica-achievements/scan_checkpoint.json`.
