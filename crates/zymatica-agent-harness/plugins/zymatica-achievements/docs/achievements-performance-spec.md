# Zymatica Achievements Performance Spec (Post-Hackathon)

Status: Draft (no code changes yet)
Owner: zymatica-achievements plugin
...
### `GET /api/plugins/zymatica-achievements/achievements`
...
### `POST /api/plugins/zymatica-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/zymatica-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/zymatica-achievements/overview`
...
- Persist plugin data under:
  - `~/.zymatica/plugins/zymatica-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.zymatica/plugins/zymatica-achievements/scan_checkpoint.json`
...
- `~/.zymatica/plugins/zymatica-achievements/`
