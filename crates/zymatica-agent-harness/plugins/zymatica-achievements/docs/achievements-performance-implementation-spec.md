# Zymatica Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.zymatica/plugins/zymatica-achievements/state.json` (existing unlock state)
  - `~/.zymatica/plugins/zymatica-achievements/scan_snapshot.json` (new)
  - `~/.zymatica/plugins/zymatica-achievements/scan_checkpoint.json` (new)
