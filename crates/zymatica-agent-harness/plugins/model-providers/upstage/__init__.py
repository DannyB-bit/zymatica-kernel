...
# When the user hasn't picked a reasoning effort, Zymatica passes
...
# ON at this effort — matching the "medium (default)" that Zymatica' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Zymatica' effort vocabulary onto Solar's accepted set. xhigh/max/
