...
class XAIImageGenProvider(ImageGenProvider):
    ...
    def get_setup_schema(self) -> Dict[str, Any]:
        ...
        # hook (``zymatica_cli/tools_config.py``); identical to the TTS / video
        ...
        **kwargs: Any,
        ...
        if not api_key:
            return error_response(
                error="No xAI credentials found. Configure xAI OAuth in `zymatica model` or set XAI_API_KEY.",
        ...
        storage_options = build_xai_storage_options(
            "image_gen",
            filename_prefix="zymatica-xai-image",
            extension="png",
        )
