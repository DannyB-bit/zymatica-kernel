...
Configuration
-------------
Secret (lives in $ZYMATICA_HOME/.env or the environment):
...
Behavioral settings (live in $ZYMATICA_HOME/mem0.json, set via `zymatica memory
setup`):
  ...
  agent_id           — Agent identifier (default: zymatica)
...
_DEFAULT_USER_ID = "zymatica-user"
...
def _load_config() -> dict:
    """Load config from env vars, with $ZYMATICA_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "zymatica"),
        "oss": {},
    }
    ...
    config_path = get_zymatica_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, zymatica_home):
        """Write config to $ZYMATICA_HOME/mem0.json."""
        import json
    ...
    def post_setup(self, zymatica_home: str, config: dict) -> None:
        ...
        post_setup(zymatica_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $ZYMATICA_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "zymatica")
