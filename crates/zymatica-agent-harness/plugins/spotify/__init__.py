...
``_check_spotify_available()`` — when the user has not run ``zymatica auth
spotify``, the tools remain registered (so they appear in ``zymatica
...
The Spotify auth flow (``zymatica auth spotify``), CLI plumbing, and docs
