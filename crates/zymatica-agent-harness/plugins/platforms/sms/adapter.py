...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Zymatica gateway adapter.

    Each inbound phone number gets its own Zymatica session (multi-tenant).
...
# static dict in zymatica_cli/gateway.py, and the _send_sms dispatch in
