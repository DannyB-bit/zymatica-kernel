...
// `message.content.text` before Zymatica can see it. We rewrite the two inbound
...
const MARKER = "Zymatica patch: Preserve mixed text + attachment iMessage payloads";
