...
Config: ~/.zymatica/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.zymatica/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_zymatica_home()`` helper (ZYMATICA_HOME-aware and
...
RULES_FILE = get_zymatica_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_zymatica_home() / "feishu_comment_pairing.json"
