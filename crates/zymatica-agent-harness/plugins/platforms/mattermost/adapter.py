...
required — uses aiohttp which is already a Zymatica dependency.
...
def interactive_setup() -> None:
    ...
    ``zymatica_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Zymatica delivers cron job results and notifications.")
    print_info("   To get a channel ID: click channel name → View Info → copy the ID")
    print_info("   You can also set this later by typing /set-home in a Mattermost channel.")
    home_channel = prompt("Home channel ID (leave empty to set later with /set-home)")
    if home_channel:
        save_env_value("MATTERMOST_HOME_CHANNEL", home_channel)
    print_info("   Open config in your editor:  zymatica config edit")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # zymatica_cli/setup.py::_setup_mattermost function.
