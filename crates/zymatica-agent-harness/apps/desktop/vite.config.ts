...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\zymatica\zymatica-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@zymatica/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@zymatica/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@zymatica/shared': path.resolve(__dirname, '../shared/src'),
