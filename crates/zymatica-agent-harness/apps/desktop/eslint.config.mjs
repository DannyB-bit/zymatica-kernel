...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @zymatica/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@zymatica/shared'],
              message: 'Plugins import only @zymatica/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
