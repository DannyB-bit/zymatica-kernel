import type { ZymaticaReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ZymaticaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ZymaticaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
