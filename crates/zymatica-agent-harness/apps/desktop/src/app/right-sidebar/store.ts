...
const TAKEOVER_KEY = 'zymatica.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Zymatica can't clear via the API — the user
 *  sees exactly what runs instead of Zymatica silently deleting their creds. */
