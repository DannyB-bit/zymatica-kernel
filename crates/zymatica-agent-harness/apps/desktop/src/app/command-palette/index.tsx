...
import { getZymaticaConfigRecord, listAllProfileSessions } from '@/zymatica'
...
// Zymatica session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getZymaticaConfigRecord,
    enabled: open
  })
    ...
    return [
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          {
            icon: Download,
            id: 'cc-update-zymatica',
            keywords: ['update', 'upgrade', 'zymatica', 'version', 'system', 'restart'],
            label: cc.updateZymatica,
