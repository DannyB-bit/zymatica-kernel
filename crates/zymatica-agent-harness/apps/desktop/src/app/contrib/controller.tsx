...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <zymatica home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('zymatica:open-keybinds'))
    } satisfies PaletteContribution
  }
])
...
const $logsOpen = persistentAtom('zymatica.desktop.logsOpen', false, Codecs.bool)
