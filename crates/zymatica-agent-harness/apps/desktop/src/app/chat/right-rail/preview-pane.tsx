        ...
        <>
          <a
            ...
            onClick={event => {
              ...
              void window.zymaticaDesktop?.openExternal(error.url)
            }}
          >
...
export function PreviewPane({
  ...
  const restartServer = useCallback(async () => {
    ...
    // "Ask Zymatica to restart the server" looked like it did nothing —
  ...
  useEffect(() => {
    if (
      ...
      !window.zymaticaDesktop?.watchPreviewFile ||
      !window.zymaticaDesktop?.onPreviewFileChanged
    ) {
      return
    }
    ...
    const unsubscribe = window.zymaticaDesktop.onPreviewFileChanged(payload => {
    ...
    void window.zymaticaDesktop
      ...
      .then(watch => {
        if (!active) {
          void window.zymaticaDesktop?.stopPreviewFileWatch?.(watch.id)
    ...
    return () => {
      ...
      if (watchId) {
        void window.zymaticaDesktop?.stopPreviewFileWatch?.(watchId)
      }
    }
  ...
  useEffect(() => {
    ...
    webview.setAttribute('partition', 'persist:zymatica-preview')
