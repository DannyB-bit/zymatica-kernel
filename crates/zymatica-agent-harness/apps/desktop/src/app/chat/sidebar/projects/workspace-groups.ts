...
import type { ProjectInfo, SessionInfo } from '@/zymatica'
 ...
 * repo shows its branches/worktrees even when they have no Zymatica sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ZymaticaGitWorktree[]
): SidebarSessionGroup[] {
