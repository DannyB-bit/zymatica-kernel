...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/zymatica'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('zymatica:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('zymatica:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Zymatica to
