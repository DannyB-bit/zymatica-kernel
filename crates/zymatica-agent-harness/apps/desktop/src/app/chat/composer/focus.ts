...
const FOCUS_EVENT = 'zymatica:composer-focus'
const INSERT_EVENT = 'zymatica:composer-insert'
const INSERT_REFS_EVENT = 'zymatica:composer-insert-refs'
const SUBMIT_EVENT = 'zymatica:composer-submit'
const VOICE_TOGGLE_EVENT = 'zymatica:composer-voice-toggle'
