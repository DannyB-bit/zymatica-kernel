...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/zymatica'
...
const VERSION = 3
const PREFIX = 'HML' // "Zymatica Memory Loadout" — namespaces our codes like WoW's leading bytes.
