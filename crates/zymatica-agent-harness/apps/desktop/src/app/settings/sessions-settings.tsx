...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/zymatica'
...
// / Program Files), which buried any files Zymatica wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.zymaticaDesktop` is
    ...
    const settings = window.zymaticaDesktop?.settings
