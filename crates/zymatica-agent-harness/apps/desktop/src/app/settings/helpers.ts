...
import type { ConfigFieldSchema, ZymaticaConfigRecord, ToolsetInfo } from '@/types/zymatica'
...
export function getNested(obj: ZymaticaConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ZymaticaConfigRecord, path: string, value: unknown): ZymaticaConfigRecord {
...
function personalityOptions(config: ZymaticaConfigRecord): string[] {
...
function commandProviderNames(config: ZymaticaConfigRecord, section: 'tts' | 'stt'): string[] {
