...
import type { ToolsetConfig } from '@/types/zymatica'
  ...
  describe('managed Nous provider activation', () => {
    ...
    it('drives the existing Nous OAuth device-code flow from the sign-in action and refetches', async () => {
      ...
      startOAuthLogin.mockResolvedValue({
        ...
        session_id: 'sess-1',
        user_code: 'NOUS-1234',
        verification_url: 'https://portal.zymatica.space/device?user_code=NOUS-1234',
        poll_interval: 5,
        expires_in: 600
      })
      ...
      try {
        ...
        expect(openSpy).toHaveBeenCalledWith(
          'https://portal.zymatica.space/device?user_code=NOUS-1234',
          '_blank',
          'noopener,noreferrer'
        )
