...
const desktopWindow = window as unknown as { zymaticaDesktop?: Window['zymaticaDesktop'] }
const initialZymaticaDesktop = desktopWindow.zymaticaDesktop

function installDesktopBridge(partial: Partial<Window['zymaticaDesktop']> = {}) {
  desktopWindow.zymaticaDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['zymaticaDesktop']
}
...
afterEach(() => {
  ...
  if (initialZymaticaDesktop) {
    desktopWindow.zymaticaDesktop = initialZymaticaDesktop
  } else {
    delete desktopWindow.zymaticaDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['zymaticaDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['zymaticaDesktop']['openExternal'] })
