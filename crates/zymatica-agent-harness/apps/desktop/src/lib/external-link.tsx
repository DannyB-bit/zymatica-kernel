...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|zymatica):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.zymaticaDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.zymaticaDesktop?.openExternal?.(href)
  }
}
