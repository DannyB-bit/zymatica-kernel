...
export interface PetInfo {
  ...
  // the Zymatica "run" activity state uses the in-place running row).
 ...
 * ZYMATICA_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'zymatica.desktop.pet-roam.v1'
