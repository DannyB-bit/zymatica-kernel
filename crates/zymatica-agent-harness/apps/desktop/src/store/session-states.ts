...
const TILES_KEY = 'zymatica.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'zymatica.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __ZYMATICA_LAYOUT_TREE__).
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ZYMATICA_SESSION_TILES__ = {
