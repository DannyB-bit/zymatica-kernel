...
import type { ZymaticaGitWorktree, ZymaticaRepoStatus } from '@/global'
...
export const $repoStatus = atom<ZymaticaRepoStatus | null>(null)
...
export const $repoWorktrees = atom<ZymaticaGitWorktree[]>([])
...
interface RepoStatusRefreshRequest {
  probe: (cwd: string) => Promise<ZymaticaRepoStatus | null>
  seq: number
  target: string
}
