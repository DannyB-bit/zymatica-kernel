 ...
 * `<zymatica home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'zymatica.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'zymatica.desktop.disabledPlugins.v1'
