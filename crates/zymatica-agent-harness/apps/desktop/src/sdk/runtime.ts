 ...
 * plugins resolve `@zymatica/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ZYMATICA_PLUGIN_SDK__: sdk,
  __ZYMATICA_REACT__: React,
  __ZYMATICA_REACT_JSX__: jsxRuntime,
  __ZYMATICA_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@zymatica/plugin-sdk': shimUrl('__ZYMATICA_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ZYMATICA_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ZYMATICA_REACT_JSX__'),
    react: shimUrl('__ZYMATICA_REACT__')
  }
