/**
 * @zymatica/plugin-sdk — THE plugin language. The vscode-module model: plugin
 ...
 *    object as `window.__ZYMATICA_PLUGIN_SDK__` and maps the import to it, so a
...
import { getLogs, getStatus } from '@/zymatica'
...
export type { RpcEvent, StatusResponse } from '@/types/zymatica'
