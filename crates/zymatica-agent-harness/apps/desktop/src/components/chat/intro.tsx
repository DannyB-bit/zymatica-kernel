...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Zymatica look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Zymatica need to see?`,
    ...
    {
      headline: `What should ${label} Zymatica tackle?`,
