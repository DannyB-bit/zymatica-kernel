...
import { getGlobalModelOptions } from '@/zymatica'
...
import type { ModelOptionProvider, OAuthProvider } from '@/types/zymatica'
...
// Zymatica Portal OAuth), ahead of OpenRouter and the rest of the key catalog.
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/DannyB-bit/Zymatica.space-BODY#bring-your-own-endpoint',
    placeholder: 'http://127.0.0.1:8000/v1'
  }
]

// Build the FULL API-key provider catalog from the backend model options so the
// onboarding / Providers key form lists every `api_key` provider `zymatica model`
...
const SHOW_ALL_KEY = 'zymatica-onboarding-show-all-v1'
