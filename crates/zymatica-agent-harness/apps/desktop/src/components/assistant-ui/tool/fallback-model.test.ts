  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://zymatica.space/docs' },
    ...
    expect(view.title).toBe('Failed to open zymatica.space/docs')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://zymatica.space/docs' },
        result: { success: true, url: 'https://zymatica.space/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened zymatica.space/docs')
  })
})
