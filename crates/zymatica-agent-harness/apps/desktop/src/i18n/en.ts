...
export const en: Translations = {
  ...
  boot: {
    ready: 'Zymatica Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Zymatica settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingZymaticaDesktop: 'Starting Zymatica Desktop…'
    },
    errors: {
      backgroundExited: 'Zymatica background process exited.',
      backgroundExitedDuringStartup: 'Zymatica background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Zymatica backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateZymatica: 'Update Zymatica',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Zymatica Desktop.',
    ...
    native: {
      ...
      inputBody: 'Zymatica is waiting for your response.',
      turnDoneTitle: 'Zymatica finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Zymatica defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Zymatica writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Zymatica is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Zymatica asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Zymatica was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Zymatica follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Zymatica is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Zymatica, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Zymatica checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Zymatica configuration...',
    ...
    gateway: {
      ...
      intro:
        'Zymatica Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Zymatica backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset ZYMATICA_DESKTOP_REMOTE_URL and ZYMATICA_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Zymatica backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Zymatica backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Zymatica Cloud',
      cloudDesc: 'Sign in once to Zymatica Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Zymatica Cloud',
      cloudSignIn: 'Sign in to Zymatica Cloud',
      cloudSignedIn: 'Signed in to Zymatica Cloud',
      cloudNeedsSignIn: 'Sign in to Zymatica Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Zymatica Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Zymatica Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Zymatica Cloud',
      cloudSignedOutMessage: 'Cleared the Zymatica Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /zymatica.',
      ...
      restartingMessage: 'Zymatica Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Zymatica ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Zymatica runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Zymatica at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a Zymatica subscription — sign in to Zymatica Portal to activate.',
      nousAuthNeededTitle: 'Sign in to Zymatica Portal',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to Zymatica Portal.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'Zymatica Portal connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'Zymatica Portal sign-in did not complete',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via zymatica curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Zymatica builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Zymatica to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Zymatica to generate pets.',
      backgroundHint: 'You can close this — Zymatica will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Zymatica desktop' },
    ...
    zymaticaActiveSessions: (version, count) => `Zymatica ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@zymatica:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Zymatica environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Zymatica will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Zymatica backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Zymatica. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Zymatica...',
    placeholderReconnecting: 'Reconnecting to Zymatica…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Zymatica a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Zymatica will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Zymatica to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Zymatica…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Zymatica…',
    ...
    unsupportedMessage: 'This version of Zymatica can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Zymatica from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Zymatica will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Zymatica desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Zymatica updater takes over in its own window and reopens Zymatica automatically when it’s done. Please don’t reopen Zymatica yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Zymatica reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Zymatica reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Zymatica needs a one-time install',
    ...
    settingUpTitle: 'Setting up Zymatica Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Zymatica CLI or desktop instance is running. Stop any running Zymatica instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Zymatica Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Zymatica is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Zymatica…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Zymatica',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Zymatica at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Zymatica connects automatically',
    ...
    authorizeThere: 'Authorize Zymatica there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Zymatica there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Zymatica subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Zymatica Desktop v${version}`,
      ...
      gatewayTitle: 'Zymatica inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Zymatica will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Zymatica is restarting...',
      askRestart: 'Ask Zymatica to restart the server',
      lookingRestart: taskId => `Zymatica is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Zymatica is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Zymatica finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Zymatica could not restart the server.',
      stillWorking:
        'Zymatica is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Zymatica is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Zymatica gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.zymatica/config.yaml). Zymatica won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Zymatica needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Zymatica needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Zymatica Desktop to use Save Image.',
    restartToSaveImages: 'Restart Zymatica Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `zymatica gateway` running?'
    }
  },
