...
cd apps/desktop
XCURSOR_SIZE=24 ZYMATICA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/zymatica-typing
# → /tmp/zymatica-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/zymatica-typing.before.heapsnapshot
# → /tmp/zymatica-typing.after.heapsnapshot
```
