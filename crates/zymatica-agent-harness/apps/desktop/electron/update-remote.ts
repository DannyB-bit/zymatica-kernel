 ...
 *
 * A public install can end up with `origin=git@github.com:DannyB-bit/Zymatica.space-BODY.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/DannyB-bit/Zymatica.space-BODY.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/DannyB-bit/Zymatica.space-BODY'
