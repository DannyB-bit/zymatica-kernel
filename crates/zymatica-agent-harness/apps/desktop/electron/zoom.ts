...
export const ZOOM_STORAGE_KEY = 'zymatica:desktop:zoomLevel'
 ...
 * but forgot to emit 'zymatica:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('zymatica:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
