...
// even though a fresh shell — and the Zymatica CLI — sees it immediately. The
// desktop's ZYMATICA_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\zymatica. Reading
...
//       ZYMATICA_HOME    REG_SZ    F:\Zymatica\data
//
