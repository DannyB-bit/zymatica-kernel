#!/usr/bin/env python3
"""
SWE Runner with Zymatica Trajectory Format

A runner that uses Zymatica-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Zymatica-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Zymatica-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Zymatica format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Zymatica-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Zymatica-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Zymatica Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Zymatica-Agent's built-in execution environments
    and outputs trajectories in Zymatica-Agent format.
    """
    ...
    def _convert_to_zymatica_format(
        self,
        ...
        """
        Convert internal message format to Zymatica trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Zymatica trajectory format
        trajectory = self._convert_to_zymatica_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Zymatica trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Zymatica Trajectory Format")
    print("=" * 60)
