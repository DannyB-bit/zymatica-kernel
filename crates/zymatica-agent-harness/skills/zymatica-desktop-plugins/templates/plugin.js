/**
 * Zymatica desktop plugin template. Save as:
 *   <zymatica home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <zymatica home> is ~/.zymatica by default, or ~/.zymatica/profiles/<name>
 * when running a named profile (`zymatica -p <name>`). Run `zymatica doctor` (or
 ...
 * Only these imports resolve: @zymatica/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@zymatica/plugin-sdk'
