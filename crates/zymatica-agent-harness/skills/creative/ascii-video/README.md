...
Built for [Zymatica Agent](https://github.com/DannyB-bit/Zymatica.space-BODY). Usable in any coding agent. Canonical source lives here; synced to [`DannyB-bit/Zymatica.space-BODY/skills/creative/ascii-video`](https://github.com/DannyB-bit/Zymatica.space-BODY/tree/main/skills/creative/ascii-video) via PR.
