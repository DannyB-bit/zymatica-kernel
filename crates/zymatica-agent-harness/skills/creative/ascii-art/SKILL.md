...
```bash
python3 -m pyfiglet "ZYMATICA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ZYMATICA&font=Slant" | boxes -d stone
```
