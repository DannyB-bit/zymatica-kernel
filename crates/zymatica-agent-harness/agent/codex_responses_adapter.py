...
# output items.  Zymatica injects xAI's native ``web_search`` for the xAI
...
# server-assigned base64 blobs that can run 400+ chars, while Zymatica-minted
...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on Zymatica threading encrypted reasoning back across
                ...
                if isinstance(codex_reasoning, list):
                    for ri in codex_reasoning:
                        if isinstance(ri, dict) and ri.get("encrypted_content"):
                            ...
                            # it is a Zymatica-side metadata key and not part
...
def _normalize_codex_response(
    ...
    *,
    ...
    if tool_calls:
        ...
        # See https://github.com/DannyB-bit/Zymatica.space-BODY/issues/64434
