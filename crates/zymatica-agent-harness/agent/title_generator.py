...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from agent code paths where a module-level zymatica_cli import risks
...
def auto_title_session(
    ...
    post-``zymatica update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running Zymatica process): %s",
            e,
        )
