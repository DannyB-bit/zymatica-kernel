...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``zymatica logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Zymatica only initiates compaction in "zymatica" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Zymatica preflight compression for codex app-server "
                "(mode=%s); Zymatica will not start thread compaction here.",
