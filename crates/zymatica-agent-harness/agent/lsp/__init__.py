"""Language Server Protocol (LSP) integration for Zymatica Agent.

Zymatica runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``zymatica chat`` exit would leak pyright processes that
