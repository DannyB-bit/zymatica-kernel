...
See the ``zymatica-agent-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Zymatica, e.g. 'zymatica-agent').\n"
    "  • Hub-installed skills (installed via 'zymatica skills install').\n"
    "Pinned skills (marked via 'zymatica curator pin') CAN be improved — "
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("ZYMATICA_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
...
def _run_review_in_thread(
    ...
    try:
        ...
        with thread_scoped_silence():
            ...
            # scratch (fresh _zymatica_now() timestamp, fresh
