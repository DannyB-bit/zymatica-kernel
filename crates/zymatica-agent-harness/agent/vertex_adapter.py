"""Vertex AI (Google Cloud) adapter for Zymatica Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Zymatica to use Gemini models via Google Cloud with
...
# who installed plain `zymatica-agent` and only later selected a Gemini model.
try:
