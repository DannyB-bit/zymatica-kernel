...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Zymatica's web-provider config and
        ...
        # native search engine for xAI sessions instead of Zymatica's
        # configured web provider (Tavily/etc.), and those results bypass
        # Zymatica's tool-trace / citation plumbing (they arrive baked into the
