...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Zymatica/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Zymatica'
    ...
    # is stricter (low/high). Clamp Zymatica's wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Zymatica-internal scaffolding markers — any top-level message key
        ...
        for msg_idx, msg in enumerate(messages):
            ...
            # Drop all Zymatica-internal scaffolding markers (``_``-prefixed).
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        # Bedrock (e.g. Zymatica Portal) surface a Claude refusal this way — or via
