"""Windows UTF-8 bootstrap for Zymatica entry points.
...
should be imported at the very top of every Zymatica entry point
(``zymatica``, ``zymatica-agent``, ``zymatica-acp``, ``python -m gateway.run``,
...
# Apply on import — entry points just need ``import zymatica_bootstrap``
# (or ``from zymatica_bootstrap import apply_windows_utf8_bootstrap``) at
