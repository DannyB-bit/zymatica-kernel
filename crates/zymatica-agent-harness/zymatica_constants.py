...
def get_zymatica_home() -> Path:
    ...
    ``zymatica_cli/kanban_db.py``).  See https://github.com/DannyB-bit/Zymatica.space-BODY/issues/18594.
    """
...
def _get_packaged_data_dir(name: str) -> Path | None:
    ...
    Used to discover bundled skills/optional-skills when Zymatica is installed
...
def get_bundled_skills_dir(default: Path | None = None) -> Path:
    ...
    Resolution order:
        ...
        4. ``<ZYMATICA_HOME>/skills`` last-resort
    """
...
def get_zymatica_dir(new_subpath: str, old_name: str) -> Path:
        ...
        for name in names:
            ...
            if candidate.is_file() and (
                ...
                if node_tool_runnable(resolved):
                    return resolved
                broken_present = True
    if broken_present and heal_zymatica_managed_node():
        for directory in iter_zymatica_node_dirs():
            for name in names:
                candidate = directory / name
                if candidate.is_file() and (
...
def display_zymatica_home() -> str:
    """Return a display-friendly string for the Zymatica home directory."""
    return str(get_zymatica_home())


display_zymatica_home = display_zymatica_home


def display_zymatica_home_path() -> str:
...
def secure_parent_dir(path: Path) -> None:
    ...
    See https://github.com/DannyB-bit/Zymatica.space-BODY/issues/25821.
    """
...
def is_container() -> bool:
    ...
    See: DannyB-bit/Zymatica.space-BODY#47111
    """
